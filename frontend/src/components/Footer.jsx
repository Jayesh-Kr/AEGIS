    ...
    <footer className="py-12 px-4 sm:px-6 lg:px-8 bg-black/30 backdrop-blur-sm border-t border-white/10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.github.com/Lviffy/AEGIS" target="_blank" className="text-gray-400 hover:text-purple-400 transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">© 2025 AEGIS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
